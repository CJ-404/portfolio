...
export const projects = [
    ...
    },
    {
        iconUrl: ceeserver,
        theme: 'btn-back-red',
        name: 'Cee-Lightning Server',
        description: 'Cee-Lightning Server is a simple web server like apache that cab serve html pages as well as json responses like an API, but it is written solely in C. It is a simple open source project that I started to learn how web servers work behind the seen.',  
    ...
    },
    {
        ...
        theme: 'btn-back-blue',
        name: 'gll-app',
        description: 'gll-app is an ongoing business mobile application for an organization in the education domain.',
        link: '',
        isOSS: false,
    },
    {
